	...
	<form id="questionario" action="${pageContext.request.contextPath}/" method="post">
		<div id="prova" class="mdl-grid">
			...
			<% for(int i=0; i < questoes.length; i++) { %>
				<div id="questoes" class="mdl-cell mdl-cell--6-col">
				...
				<div id="respostas" class="mdl-cell mdl-cell--6-col">
			...
			<% } %>
			<input type="submit" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised" value="Enviar Respostas" style="text-align:center">
		</div>		
	</form>
</body>
</html>